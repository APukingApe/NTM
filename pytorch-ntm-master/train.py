...
"""Training for the InterLeave Task in Neural Turing Machines."""
...
from tasks.InterLeaveTask import InterLeaveTaskModelTraining, InterLeaveTaskParams

TASKS = {
    'InterLeave': (InterLeaveTaskModelTraining, InterLeaveTaskParams),
}
...
def train_model(model, args):
    ...
    for batch_num, x, y, seq in model.dataloader:
...
def init_arguments():
    ...
    parser.add_argument('--task', action='store', choices=list(TASKS.keys()), default='InterLeave',
                        help="Choose the task to train (default: InterLeave)")
